/*  
    Arduino PS2 Memory Card Reader - MemCARDuino2, PinkieIcePie 2016

    Thanks to:
    Shendo - Original MemCARDuino Code and Concept. 
...
#define IDENTIFIER "MCDINO2"  //MemCARDuino2
...
{
  byte AddressMSB = Address & 0xFFC;
  byte AddressLSB = (Address >> 8) & 0xFFC;
